...
export async function upsertInvitation(input: Partial<Invitation> & { title: string }): Promise<Invitation> {
  ...
  const data: Invitation = {
    ...
    sections: input.sections ?? ["hero", "details", "countdown", "timeline", "family", "parish", "reception", "gallery", "message", "dressCode", "rsvp", "music"],
    sectionOrder: input.sectionOrder ?? existing?.sectionOrder ?? ["hero", "details", "countdown", "timeline", "family", "parish", "reception", "gallery", "message", "dressCode", "rsvp", "music"],
